...
白狼このはさん向けに、既存のVTuberサイト構成をベースとして作った公式サイトです。
...
- `index.html`: トップ、プロフィール、ムービー/配信リンク
- `gallery.html`: 立ち絵、アイコン、CSSアニメーション演出
- `fan.html`: Twitch、YouTube、Xへの推し活導線
- `guideline.html`: タグ、ファンマーク、応援ガイドライン
- `contact.html`: 案件相談ページ
